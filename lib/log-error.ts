...
// Called from app/api/log-error/route.ts (client-reported errors) and, in-process,
// from lib/api.ts when it's running in a Server Component / Route Handler context.

const APP_NAME = "Priinteve Web";
